	...
	this.addSkin=function() {
		...
		me.__52.logicBlock_position = function() {
			...
			if (me.__52.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__52.style.transition='left 0s, top 0s, width 0s, height 0s, transform 0s';
				if (me.__52.ggCurrentLogicStatePosition == 0) {
					me.__52.style.left='10px';
					me.__52.style.top='45px';
				}
				else {
					me.__52.style.left='15px';
					me.__52.style.top='80px';
				}
			}
		}
		me.__52.logicBlock_position();
		me.__52.logicBlock_size = function() {
			...
			if (me.__52.ggCurrentLogicStateSize != newLogicStateSize) {
				me.__52.ggCurrentLogicStateSize = newLogicStateSize;
				me.__52.style.transition='left 0s, top 0s, width 0s, height 0s, transform 0s';
				if (me.__52.ggCurrentLogicStateSize == 0) {
					me.__52.style.width='110px';
					me.__52.style.height='100px';
					skin.updateSize(me.__52);
				}
				else if (me.__52.ggCurrentLogicStateSize == 1) {
					me.__52.style.width='200px';
					me.__52.style.height='200px';
					skin.updateSize(me.__52);
				}
				else {
					me.__52.style.width='200px';
		...
		me.__52.logicBlock_scaling = function() {
			...
			if (me.__52.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me.__52.ggCurrentLogicStateScaling == 0) {
					me.__52.ggParameter.sx = 0.85;
					me.__52.ggParameter.sy = 0.8;
		...
		me._rectangle_41.appendChild(me.__55);
		me.__53.appendChild(me._rectangle_41);
		...
		me.__53.appendChild(me._map_11);
		...
		me.__53.appendChild(me._map_21);
		...
		me.__49.logicBlock_position = function() {
			...
			if (me.__49.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				if (me.__49.ggCurrentLogicStatePosition == 0) {
					me.__49.style.left='5px';
					me.__49.style.bottom='-120px';
				}
				else {
					me.__49.style.left='5px';
		...
		me.__49.logicBlock_visible = function() {
			...
			if (me.__49.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				else if (me.__49.ggCurrentLogicStateVisible == 2) {
					me.__49.style.visibility="hidden";
					me.__49.ggVisible=false;
				}
				else if (me.__49.ggCurrentLogicStateVisible == 3) {
					me.__49.style.visibility="hidden";
					me.__49.ggVisible=false;
				}
				else {
		...
		me._rectangle_40.appendChild(me.__51);
		me.__50.appendChild(me._rectangle_40);
		...
		me.__50.appendChild(me._map_10);
		...
		me.__50.appendChild(me._text_4);
		...
		me.__50.appendChild(me._map_20);
		...
		me.__46.logicBlock_position = function() {
			...
			if (me.__46.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me.__46.style.transition='left 500ms ease 0ms, top 500ms ease 0ms, width 0s, height 0s, transform 0s';
				if (me.__46.ggCurrentLogicStatePosition == 0) {
					me.__46.style.left = 'calc(50% - (100% / 2) + (0px / 2) + 5px)';
					me.__46.style.top = 'calc(50% - (70% / 2) + (0px / 2) + -120px)';
				}
				else {
					me.__46.style.left='calc(50% - ((100% + 0px) / 2) + 0px)';
					me.__46.style.top='calc(50% - ((70% + 0px) / 2) + 0px)';
				}
			}
		}
		...
		me.__46.logicBlock_size = function() {
			...
			if (me.__46.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__46.ggCurrentLogicStateSize == 0) {
					me.__46.style.width='100%';
					me.__46.style.height='100%';
					...
					me.__46.style.width='100%';
					me.__46.style.height='70%';
					me.__46.style.left = 'calc(50% - (100% / 2))';
					me.__46.style.top = 'calc(50% - (70% / 2))';
					skin.updateSize(me.__46);
				}
			}
		}
		...
		me.__47.logicBlock_size = function() {
			...
			if (me.__47.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				me.__47.style.transition='width 0s, height 0s';
				if (me.__47.ggCurrentLogicStateSize == 0) {
					me.__47.style.width='100%';
					me.__47.style.height='100%';
					me.__47.style.left = 'calc(50% - (100% / 2) + (0px / 2) + -32px)';
					skin.updateSize(me.__47);
				}
				else {
					me.__47.style.width='90%';
					me.__47.style.height='100%';
					me.__47.style.left = 'calc(50% - (90% / 2) + (0px / 2) + -32px)';
					skin.updateSize(me.__47);
				}
			}
		}
		...
		me.__48.logicBlock_size = function() {
			...
			if (me.__48.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				if (me.__48.ggCurrentLogicStateSize == 0) {
					...
					me.__48.style.left = 'calc(50% - (90% / 2))';
		...
		hs+='position : absolute;';
		hs+='top : calc(50% - ((60.67% + 0px) / 2) + 0px);';
		hs+='visibility : inherit;';
		hs+='width : 61%;';
		hs+='pointer-events:none;';
		el.setAttribute('style',hs);
